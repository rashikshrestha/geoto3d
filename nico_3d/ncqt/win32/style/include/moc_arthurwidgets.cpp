...
#include "../../../style/include/arthurwidgets.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ArthurFrame_t, stringdata) + ofs \
...
void ArthurFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ArthurFrame::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ArthurFrame::descriptionEnabledChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ArthurFrame::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ArthurFrame.data,
      qt_meta_data_ArthurFrame,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ArthurFrame.stringdata))
