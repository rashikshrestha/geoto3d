...
struct qt_meta_stringdata_ncQtDock_t {
    QByteArrayData data[4];
    char stringdata[20];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_ncQtDock_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_ncQtDock_t qt_meta_stringdata_ncQtDock = {
    {
...
void ncQtDock::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ncQtDock::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ncQtDock::log)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ncQtDock::staticMetaObject = {
    { &QDockWidget::staticMetaObject, qt_meta_stringdata_ncQtDock.data,
      qt_meta_data_ncQtDock,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ncQtDock.stringdata))
