...
static const char qt_meta_stringdata_ncQtDoubleSliderCombo[] = {
    "ncQtDoubleSliderCombo\0\0valueChanged(double)\0"
    "value\0setValue(double)\0setValue(int)\0"
    "sendValueChanged()\0"
};
...
const QMetaObjectExtraData ncQtDoubleSliderCombo::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ncQtDoubleSliderCombo::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ncQtDoubleSliderCombo,
      qt_meta_data_ncQtDoubleSliderCombo, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ncQtDoubleSliderCombo::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ncQtDoubleSliderCombo))
