...
struct qt_meta_stringdata_ncQtGLWidget_t {
    QByteArrayData data[7];
    char stringdata[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_ncQtGLWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_ncQtGLWidget_t qt_meta_stringdata_ncQtGLWidget = {
    {
...
QT_MOC_LITERAL(5, 31, 1),
QT_MOC_LITERAL(6, 33, 1)
    },
    "ncQtGLWidget\0log\0\0text\0resized\0w\0h\0"
};
...
void ncQtGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ncQtGLWidget::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ncQtGLWidget::log)) {
                *result = 0;
            }
        }
        {
            typedef void (ncQtGLWidget::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ncQtGLWidget::resized)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject ncQtGLWidget::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_ncQtGLWidget.data,
      qt_meta_data_ncQtGLWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ncQtGLWidget.stringdata))
